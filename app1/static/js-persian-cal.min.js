...
{var c={inputID:""
        ,extraInputID:""
        ,extraInputFormat:"JD",initialDate:"",defaultDate:"",autoCreateButton:!0
        ,divPickerClassName:"picker"
        ,btnClassName:"pcalBtn"
        ,onchange:!1}
,d;this.getOption=function(a){return c[a]};this.oldDocumentOnClick=!1;this.enabled=!0;this.inputID=b;this.input=A$(b);for(d in a)d in c?c[d]=a[d]:alert(d.toString()+" option is not supported");c.defaultDate instanceof Array||(c.defaultDate=isPersianDate(c.defaultDate));d=this.input;if(c.autoCreateButton){var e=
cE("a");e.className=c.btnClassName;e.href="#";d.parentNode.insertBefore(e,d.nextSibling);var g=this;e.onclick=function(a){g.showHidePicker(a);return!1}}var f=this;d.ondblclick=function(a){f.showHidePicker(a);return!1};var h=this;d.onblur=function(){h.normalizeUserInput()};var k=this;addEvt(d,"keydown",function(a){k.keyDownHandler(a,k)});
